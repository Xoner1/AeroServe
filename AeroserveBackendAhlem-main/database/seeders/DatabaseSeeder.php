...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Create sample points de vente
        PointDeVente::firstOrCreate(
            ['name' => 'PDV Terminal 1 - Enfidha'],
            ['name' => 'PDV Terminal 1 - Enfidha', 'airport_id' => $enfidha->id]
        );

        PointDeVente::firstOrCreate(
            ['name' => 'PDV Terminal 1 - Monastir'],
            ['name' => 'PDV Terminal 1 - Monastir', 'airport_id' => $monastir->id]
        );
